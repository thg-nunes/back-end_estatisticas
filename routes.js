...
routers.post('/getMunicipios', get_municipios.getMunicipios)
routers.post('/getPorte', get_porte.getPorte)
routers.post('/getSetor', get_setor.getSetor)
routers.post('/getNatureza', get_natureza.getNatureza)
routers.post('/getDescricaoAtividade', get_descricaoAtividade.getDescricaoAtividade)
routers.post('/getSecaoAtividade', get_secaoAtividade.getSecaoAtividade)
